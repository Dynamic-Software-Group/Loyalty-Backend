...
class BusinessEndpoints @Autowired constructor(
    ...
    private val business = Business(businessRepo, userRepo)

    @PostMapping("/create")
    fun createBusiness(@RequestHeader(HttpHeaders.AUTHORIZATION) jwt: String, request: BusinessCreateRequest) {
        business.createBusiness(jwt, request)
    }
